...
<section class="product-details">
    <div class="container product-details-container">
        <div class="product-card fade-in">
            ...
            <?php if (!empty($safety_switches)): ?>
            
            <!-- Main Product Section -->
            <div class="row align-items-center">
                
                <!-- Main product (first record) -->
                <?php $main_product = $safety_switches[0]; ?>
                
                <div class="col-lg-6 order-2 order-lg-1">
                    <h2 class="product-title"><?php echo html_escape($main_product->title); ?></h2>
                    
                    <hr class="modern-divider">

                    <!-- Product Description -->
                    <div class="product-description">
                        <p><?php echo nl2br(html_escape($main_product->content)); ?></p>
                        
                        <!-- Key Features -->
                        <?php if (!empty($main_product->features)): ?>
                        <div class="product-features">
                            <h5 class="mb-3" style="color: var(--newblue2); font-weight: 600;">Key Features:</h5>
                            <ul class="feature-list">
                                <?php 
                                $features = explode(',', $main_product->features);
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <?php if (!empty($main_product->image)): ?>
                    <div class="product-image-container">
                        <img src="<?php echo base_url('assets_system/images/' . $main_product->image); ?>"
                            alt="<?php echo html_escape($main_product->title); ?>"
                            class="product-image">
            ...
            <!-- Non-contact Safety Switch Grid -->
            <?php 
            // Check if we have any SS2 series products
            $ss2_products = array_filter($safety_switches, function($item) {
                return strpos($item->content, 'Non-contact Safety Switch') !== false;
            });
            
            if (!empty($ss2_products)):
            ?>
            ...
            <div class="image-grid">
                <?php 
                $counter = 0;
                foreach ($ss2_products as $product): 
                    $counter++;
                ?>
                <a href="<?php echo site_url('index/ss_' . $product->id); ?>" class="product-link">
                    <div class="item">
                        <?php if ($counter == 1): ?>
                        <div class="badge">NEW</div>
                        <?php endif; ?>
                        <img src="<?php echo base_url('assets_system/images/' . $product->image); ?>" 
                             alt="<?php echo html_escape($product->title); ?>">
                        <h3 class="product-title1"><?php echo html_escape($product->title); ?></h3>
                        ...
                        <div class="tags">
                            ...
                            if (!empty($product->features)) {
                                ...
                                foreach ($features as $feature) {
                                    $feature = trim($feature);
                                    if (!empty($feature)) {
                                        echo '<span class="tag">' . html_escape($feature) . '</span>';
                                    }
                                }
                            }
                            ?>
            ...
            <!-- Safety Relay Unit Grid -->
            <?php 
            // Check if we have any Safety Relay Unit products
            $relay_products = array_filter($safety_switches, function($item) {
                return strpos($item->title, 'Safety Relay Unit') !== false;
            });
            
            if (!empty($relay_products)):
            ?>
            <div class="title-header">
            ...
            <div class="image-grid">
                <?php 
                $counter = 0;
                foreach ($relay_products as $product): 
                    $counter++;
                ?>
                <a href="<?php echo site_url('safety_switches/product_details/' . $product->id); ?>" class="product-link">
                    <div class="item">
                        <?php if ($counter == 1): ?>
                        <div class="badge">NEW</div>
                        <?php endif; ?>
            ...
            <div class="alert alert-info">
                No safety switches found in the database.
            </div>
            <?php endif; ?>
        </div>
    </div>
