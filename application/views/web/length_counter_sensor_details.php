      ...
      <div class="product-card fade-in">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 order-2 order-lg-1">
            <h2 class="product-title">Length Counters & Sensors</h2>
            ...
            <div class="product-description">
              <p>
                Our Slide Limit Counters, also known as Shut height Counters,
are designed for press machines and various machine tools to adjust the die height or the shut height.
These Slide Adjusters can output a signal at preset Upper and Lower limit.
              </p>
              
              <div class="product-features">
                <h5 class="mb-3" style="color: var(--newblue2); font-weight: 600;">Key Features:</h5>
                <ul class="feature-list">
                  <li>Precise shut-height adjustment</li>
                  <li>Upper & lower limit signaling</li>
                  <li>Reliable mechanical slide design</li>
                  <li>Easy integration with machine tools</li>
                </ul>
              </div>
          ...
          <div class="col-lg-6 order-1 order-lg-2">
            <div class="product-image-container">
              <img src="<?= base_url('assets_system/images/countersensor.png')?>"
                alt="Safety Switches Product Image"
                class="product-image">
              <p class="image-caption">Advanced Slide Limit Counters for Industrial Applications</p>
            </div>
          </div>
        </div>
      </div>
