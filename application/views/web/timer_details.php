      ...
      <div class="product-card fade-in">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 order-2 order-lg-1">
            <h2 class="product-title">Timers</h2>
            ...
            <div class="product-description">
              <p>
                Our Timers range provides measurement of elapsed time in hours/minutes/seconds.
They can totalize the operating time of machines to check their operating rate.
Unit of time depends on model number.
              </p>
              
              <div class="product-features">
                <h5 class="mb-3" style="color: var(--newblue2); font-weight: 600;">Key Features:</h5>
                <ul class="feature-list">
                  <li>Multi-Unit Time Measurement</li>
                  <li>Machine Operation Totalizing</li>
                  <li>Operating Rate Analysis</li>
          ...
          <div class="col-lg-6 order-1 order-lg-2">
            <div class="product-image-container">
              <img src="<?= base_url('assets_system/images/timer.png')?>"
                alt="Safety Switches Product Image"
                class="product-image">
              <p class="image-caption">Advanced Timers for Industrial Applications</p>
            </div>
          </div>
        </div>
      </div>
