...
<main class="ml-64 p-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h1 class="text-3xl font-bold text-slate-900">Create New Event</h1>
                <p class="text-slate-500 mt-1">Add new news, events, or updates for your website</p>
            </div>
            <div class="flex gap-3">
                ...
                <button id="saveEvent" class="px-5 py-2.5 bg-indigo-600 text-white rounded-xl font-semibold shadow-md shadow-indigo-100 hover:bg-indigo-700 transition-all">Publish Event</button>
            </div>
        </div>
        ...
        <form action="<?php echo base_url('cms/store'); ?>" method="POST" enctype="multipart/form-data" id="eventForm">
            ...
            <div class="space-y-8">
                ...
                <section class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" class="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" placeholder="Enter event title" required>
                        </div>
                        
                        <div>
                            <label class="text-sm font-medium text-slate-700 mb-2 block">Content *</label>
                            <textarea name="content" class="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition min-h-[200px]" placeholder="Enter event content" required></textarea>
                        </div>
                        
                        <div>
                            <label class="text-sm font-medium text-slate-700 mb-2 block">Meta Description</label>
                            <textarea name="meta_description" class="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" placeholder="Brief description for SEO" rows="3"></textarea>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="event_date" class="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="badge_text" class="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition" placeholder="e.g., Featured Event, New Release">
                            </div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center">
                                <input type="checkbox" name="is_featured" id="is_featured" value="1" class="w-4 h-4 text-indigo-600 border-slate-300 rounded focus:ring-indigo-500">
                ...
                <section class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="mb-4">
                            <label class="text-sm font-medium text-slate-700 mb-2 block">Upload Image</label>
                            ...
                            <div class="border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center hover:border-indigo-300 transition-colors cursor-pointer" onclick="document.getElementById('image_file').click()">
                                ...
                                <p class="text-slate-700 font-medium mb-2">Click to upload image</p>
                        ...
                        <div id="imagePreview" class="hidden">
                            <div class="mt-4">
                                <label class="text-sm font-medium text-slate-700 mb-2 block">Preview</label>
