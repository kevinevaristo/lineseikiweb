                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex gap-3">
                                <select name="webinar_id" id="webinar_id" class="flex-1 px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                    <option value="0">— No Webinar —</option>
                                    <?php if(isset($webinars) && !empty($webinars)): ?>
                                        <?php foreach($webinars as $w): ?>
                                            <option value="<?= $w['id'] ?>" <?= (isset($resource['webinar_id']) && $resource['webinar_id'] == $w['id']) ? 'selected' : '' ?>><?= htmlspecialchars($w['webinar_title']) ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
