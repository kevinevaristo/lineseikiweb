...
<main class="ml-64 p-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <p class="text-gray-600">Manage your website's privacy policy content</p>
                </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-blue-900 mb-1">About Privacy Policy</h3>
                        <p class="text-sm text-blue-800">
                            Use the rich text editor below to create and format your privacy policy. This content will be displayed on your website's privacy policy page.
                            Make sure to include all required information about data collection, usage, and user rights.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="font-bold text-gray-800">Privacy Policy Content</h3>
            ...
            <div class="p-6">
                <form id="privacyPolicyForm">
                    ...
                    <div class="mb-6">
                        <label for="policyContent" class="block text-sm font-medium text-gray-700 mb-2">
                            Privacy Policy Content
                        </label>
                        <textarea id="policyContent" name="data" class="w-full border border-gray-300 rounded-lg p-4 min-h-[500px] focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"><?php echo !empty($page_data) ? htmlspecialchars($page_data['data']) : ''; ?></textarea>
                    </div>
                    
                    <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                        <div class="text-sm text-gray-500">
                            <i class="fas fa-lightbulb mr-1"></i>
                            Tip: Use headings, lists, and formatting to make your policy easy to read
                        </div>
        ...
        <div class="mt-6 grid grid-cols-3 gap-4">
            <a href="<?php echo base_url('cms/terms_of_service'); ?>" class="block p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all">
                <div class="flex items-center justify-between">
                    <div>
                        <h4 class="font-semibold text-gray-900">Terms of Service</h4>
                        <p class="text-sm text-gray-500 mt-1">Manage terms and conditions</p>
                    </div>
            ...
            <a href="<?php echo base_url('cms/cookie_settings'); ?>" class="block p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all">
                <div class="flex items-center justify-between">
                    <div>
                        <h4 class="font-semibold text-gray-900">Cookie Settings</h4>
                        <p class="text-sm text-gray-500 mt-1">Manage cookie settings page</p>
                    </div>
    ...
    <div id="previewModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-lg font-bold text-gray-900">Privacy Policy Preview</h3>
...
<script>
    ...
    document.getElementById('privacyPolicyForm').addEventListener('submit', function(e) {
        ...
        // Get TinyMCE content
        const content = tinymce.get('policyContent').getContent();
    ...
    document.getElementById('saveBtn').addEventListener('click', function() {
        document.getElementById('privacyPolicyForm').dispatchEvent(new Event('submit'));
    });
