...
<head>
	...
	<link href="<?php echo base_url('assets_system/vendor/google-fonts/lato/lato.css'); ?>" rel="stylesheet">

	<link href="<?php echo base_url('assets_system/vendor/bootstrap-5.0.1/css/bootstrap.min.css'); ?>" rel="stylesheet" integrity="sha384-+0n0xVW2eSR5OomGNYDnhzAbDsOXxcvSN1TPprVMTNDbiYZCxYbOOl7+AMvyTG2x" crossorigin="anonymous">
...
<body>
	...
	<div class="box_container">
		<div class="login-page" style="text-align:center">
			<p style="font-size:30px; font-family: 'Lato',san-serif;" class="text-primary text-bold"><b>Change Password</b></p>
			<?php
			...
			<form action="<?= base_url() ?>panel_72c81/submit_new_password" method="post">
	...
	<script src="<?php echo base_url('assets_system/vendor/bootstrap-5.0.1/js/bootstrap.bundle.min.js'); ?>" integrity="sha384-gtEjrD/SeCtmISkJkNUaaKMoLD0//ElJ19smozuHV6z3Iehds+3Ulb9Bn9Plx0x4" crossorigin="anonymous"></script>
</body>
