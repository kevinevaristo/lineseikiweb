    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Cookie Policy Management</h1>
                    <p class="text-gray-600">Manage your website's cookie usage policy</p>
                </div>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-blue-900 mb-1">About Cookie Policy</h3>
                        <p class="text-sm text-blue-800">
                            Use the rich text editor below to create and format your cookie policy. This content will be displayed on your website's cookie policy page.
                            Explain what cookies your website uses, why you use them, and how users can manage their cookie preferences.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="font-bold text-gray-800">Cookie Policy Content</h3>
            ...
            <div class="p-6">
                <form id="cookieForm">
                    ...
                    <div class="mb-6">
                        <label for="cookieContent" class="block text-sm font-medium text-gray-700 mb-2">
                            Cookie Policy Content
                        </label>
                        <textarea id="cookieContent" name="data" class="w-full border border-gray-300 rounded-lg p-4 min-h-[500px] focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"><?php echo !empty($page_data) ? htmlspecialchars($page_data['data']) : ''; ?></textarea>
                    </div>
                    
                    <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                        <div class="text-sm text-gray-500">
                            <i class="fas fa-lightbulb mr-1"></i>
                            Tip: Clearly explain different cookie types (essential, functional, analytics, marketing)
                        </div>
    ...
    <div id="previewModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h3 class="text-lg font-bold text-gray-900">Cookie Policy Preview</h3>
...
<script>
    ...
    document.getElementById('cookieForm').addEventListener('submit', function(e) {
        ...
        const content = tinymce.get('cookieContent').getContent();
    ...
    document.getElementById('saveBtn').addEventListener('click', function() {
        document.getElementById('cookieForm').dispatchEvent(new Event('submit'));
    });
