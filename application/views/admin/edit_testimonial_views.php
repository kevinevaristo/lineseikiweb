...
<main class="ml-64 p-8">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-slate-500 mt-1">Update client testimonial information</p>
                </div>
    ...
    <div class="max-w-3xl mx-auto">
        <!-- Form -->
        <form action="<?php echo site_url('cms/edit_testimonial/' . $testimonial->id); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div class="p-6 border-b border-slate-100 bg-gradient-to-r from-indigo-50 to-purple-50">
                <h3 class="font-bold text-slate-800 flex items-center">
                    ...
                    Edit Testimonial #<?php echo $testimonial->id; ?>
                </h3>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="text-center mb-8">
                    <div class="image-preview-container mb-4">
                        <?php if (!empty($testimonial->image) && file_exists(FCPATH . 'assets_system/images/' . $testimonial->image)): ?>
                            <img id="imagePreview" src="<?php echo base_url('assets_system/images/' . $testimonial->image . '?t=' . time()); ?>" alt="Preview" class="image-preview">
                        <?php else: ?>
                    ...
                    <div class="mb-2">
                        <?php if (!empty($testimonial->image)): ?>
                            <span class="current-image-badge">
                                ...
                                Current: <?php echo $testimonial->image; ?>
                            </span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 mt-2">Leave empty to keep current image. Max 2MB.</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="name" value="<?php echo set_value('name', $testimonial->name); ?>" required
                ...
                <div>
                    ...
                    <input type="text" name="position" value="<?php echo set_value('position', $testimonial->position); ?>"
                           class="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
                ...
                <div>
                    ...
                    <textarea name="content" rows="5" required
                              ...
                              placeholder="Write the testimonial here..."><?php echo set_value('content', $testimonial->content); ?></textarea>
                ...
                <div style="display: none">
                    ...
                    <input type="number" name="sort_order" value="<?php echo set_value('sort_order', $testimonial->sort_order); ?>" min="0"
                ...
                <div class="flex items-center gap-3 p-4 bg-slate-50 rounded-xl">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo $testimonial->is_active ? 'checked' : ''; ?>>
